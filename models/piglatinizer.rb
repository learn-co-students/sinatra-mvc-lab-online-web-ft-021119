...
class PigLatinizer
  ...
  #
  #     #3 consonants
  #   elsif word.start_with?(/[bcdfghjklmnpqrstvwxyz][bcdfghjklmnpqrstvwxyz][bcdfghjklmnpqrstvwxyz]/)
  #     array = word.split("")
  #     array[3..-1].join + array[0..2].join + "ay"
  #
  #     #2 consonants
  #   elsif word.start_with?(/[bcdfghjklmnpqrstvwxyz][bcdfghjklmnpqrstvwxyz]/)
  #     array = word.split("")
  #     array[2..-1].join + array[0..1].join + "ay"
  #
  #   #1 consonant
